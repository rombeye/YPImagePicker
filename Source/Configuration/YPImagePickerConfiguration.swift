...
public struct YPImagePickerConfiguration {
    ...
    public var hidesBottomBar = true
...
public struct YPConfigLibrary {
    ...
    public var mediaType = YPlibraryMediaType.photoAndVideo
    
    /// Anything superior than 1 will enable the multiple selection feature.
    public var maxNumberOfItems = 5
    ...
    public var spacingBetweenItems: CGFloat = 16.0
...
public struct YPConfigVideo {
    ...
    public var libraryTimeLimit: TimeInterval = 60.0 * 10
